        ...
        const html = `
            ...
            <section class="about">
                ...
                <div class="about__quote">
                    ...
                    <p class="about__quote-text">“ Our mission is to produce the <span class="about__quote-color"> highest quality</span> of work for every client, on every project with full of energy we have ”</p>
